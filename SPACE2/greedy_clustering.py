...
from SPACE2.util import rmsd, parse_antibodies, cluster_antibodies_by_CDR_length, output_to_pandas, reg_def_CDR_all, reg_def_fw_all
...
def greedy_clustering(files, selection=reg_def_CDR_all, anchors=reg_def_fw_all, cutoff=1.25, n_jobs=-1):
